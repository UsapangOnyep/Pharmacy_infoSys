...
$sql = "SELECT ID, Category, Brand, Model, ItemName, ItemDesc, ReorderLevel, ItemPath,
        CASE WHEN `Status` = 1 THEN 'Active' ELSE 'Inactive' END AS `Status`  
        FROM items
        ORDER BY `Status` ASC, ItemName ASC";
...
foreach ($Items as $Item) {
    $imagePath = $_SERVER['DOCUMENT_ROOT'] . $Item['ItemPath'];
    $html .= '
                <tr>
