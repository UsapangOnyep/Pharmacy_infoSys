...
<body>
    <h1>List of Employees as of {{ DateToday }} </h1>
        ...
        foreach ($employees as $employee) {
            $html .= '
                <tr>
                    ...
                    <td>' . htmlspecialchars($employee['MName']) . '</td>
                    <td>' . htmlspecialchars($employee['Lname']) . '</td>
                    <td>' . htmlspecialchars($employee['Suffix']) . '</td>
                    <td>' . htmlspecialchars($employee['Status']) . '</td>
                </tr>';
        }
       $html .= "
            <tr><td colspan='5' textalign = center>- - - NOTHING'S FOLLOW - - -</td></tr>     
        </tbody>
    </table>
...
$dompdf->stream("List_Of_Employees" . $currentDateTime . ".pdf", ["Attachment" => 0]); 
?>
